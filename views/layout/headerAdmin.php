        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <nav class="flex items-center gap-8">
                <ul class="flex flex-row gap-6 text-sm font-medium items-center">
                    ...
                    <li><a href="#usuarios"
                            class="text-zinc-400 hover:text-white transition-colors duration-200">Administracion de
                            usuarios</a></li>
                    <li><a href="#equipos"
                            class="text-zinc-400 hover:text-white transition-colors duration-200">Modificar Equipos</a>
                    </li>
                    <li><a href="#ligas" class="text-zinc-400 hover:text-white transition-colors duration-200">Modificar
                            Ligas</a></li>
