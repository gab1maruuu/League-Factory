        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <nav>
                <ul class="flex flex-row gap-6 text-sm font-medium">
                    ...
                    <li><a href="index.php?action=register" class="rounded-3xl py-1 px-2 border border-indigo-400 text-indigo-400 hover:text-indigo-300 hover:border-indigo-300 transition-colors duration-300">Registrarse o Iniciar Sesión</a></li>
                </ul>
            </nav>
        </div>
    </header>
