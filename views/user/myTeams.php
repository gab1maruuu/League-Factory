...
<head>
    <meta charset="UTF-8">
    <title>Tus Equipos | League Factory</title>
...
<body class="bg-zinc-950 text-white font-sans">
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-8 text-indigo-400">Tus Equipos</h1>

        <?php if (empty($myTeams)): ?>
            <div class="bg-zinc-900 rounded-xl p-8 text-center border border-zinc-800">
                <p class="text-zinc-500 mb-4">No tienes ningun equipo.</p>
                <a href="index.php?action=create_team" class="inline-block bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-500 transition">Crear Equipo</a>
            </div>
        <?php else: ?>
                    ...
                    <div class="bg-zinc-900 rounded-xl overflow-hidden border border-zinc-800 hover:border-indigo-500/50 transition duration-300">
                        <div class="p-6 flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-zinc-500">Capitán: Tú</p>
                            </div>
                        </div>
